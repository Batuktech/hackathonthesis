...
export const api = {
  ...
  updateUser: (id: string, data: any) => request<any>(`/admin/users/${id}`, { method: "PATCH", body: JSON.stringify(data) }),
  ...
  updateSeason: (id: string, data: any) => request<any>(`/admin/academic-seasons/${id}`, { method: "PATCH", body: JSON.stringify(data) }),
  deleteSeason: (id: string) => request<any>(`/admin/academic-seasons/${id}`, { method: "DELETE" }),
  ...
  updateDegreeType: (id: string, data: any) => request<any>(`/admin/degree-types/${id}`, { method: "PATCH", body: JSON.stringify(data) }),
  deleteDegreeType: (id: string) => request<any>(`/admin/degree-types/${id}`, { method: "DELETE" }),
  ...
  updateSchedule: (id: string, data: any) => request<any>(`/admin/schedules/${id}`, { method: "PATCH", body: JSON.stringify(data) }),
  deleteSchedule: (id: string) => request<any>(`/admin/schedules/${id}`, { method: "DELETE" }),
